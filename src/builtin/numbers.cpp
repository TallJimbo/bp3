...
float_::float_(object const & obj) :
    base(py_ptr::steal(PyNumber_Float(obj.ptr().get()))) {}

float_::float_(double v) :
    base(py_ptr::steal(PyFloat_FromDouble(v))) {}
...
int_::int_(object const & obj) :
    base(py_ptr::steal(PyNumber_Int(obj.ptr().get()))) {}

int_::int_(long v) :
    base(py_ptr::steal(PyInt_FromLong(v))) {}

int_::operator long () const { return PyInt_AsLong(ptr().get()); }


long_::long_(object const & obj) :
    base(py_ptr::steal(PyNumber_Long(obj.ptr().get()))) {}

long_::long_(long long v) :
    base(py_ptr::steal(PyLong_FromLongLong(v))) {}

long_::long_(unsigned long long v) :
    base(py_ptr::steal(PyLong_FromUnsignedLongLong(v))) {}
