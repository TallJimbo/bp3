...
public:
    ...
    explicit from_python(context_t const & context, py_ptr const & py) :
        from_python_base(context, py, type_id<T>(), false)
    {}
...
public:
    ...
    explicit from_python(context_t const & context, py_ptr const & py) :
        from_python_base(context, py, type_id<T>(), std::is_const<T>::value)
    {}
